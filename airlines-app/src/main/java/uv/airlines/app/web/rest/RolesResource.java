...
public class RolesResource {
     ...
     *         body the new rolesDTO, or with status {@code 400 (Bad Request)} if
     *         the roles has already an ID.
     ...
     *         the updated rolesDTO, or with status {@code 400 (Bad Request)} if the
     *         rolesDTO is not valid, or with status
     *         {@code 500 (Internal Server Error)} if the rolesDTO couldn't be
     *         updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/roles")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the rolesDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/roles/{id}")
